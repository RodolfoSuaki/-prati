...
// let ultimo = 1; // Iniciando com 1 para obter a sequência correta1
// let penultimo = 0;
// console.log(penultimo); // Imprimindo o primeiro termo (0)
// console.log(ultimo); // Imprimindo o segundo termo (1)

// for (let i = 2; i < 10; i++) {
// let fibonacci = ultimo + penultimo;
// penultimo = ultimo; // Atualizando penultimo APÓS calcular fibonacci
// ultimo = fibonacci;
...
let contador = num; // Inicializa o contador com o número fornecido
